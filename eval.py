...
def evaluate_model(
    ...
    dataset = load_from_disk('./dataset/gsm8k')['test']
    if num_samples:
    ...
    if save_results:
        save_path = f"gsm8k_eval_results_SFT_{datetime.now().strftime('%Y%m%d_%H%M%S')}.json"
...
if __name__ == "__main__":
    ...
    checkpoint_path = "./../../../scratch/gpfs/my0049/Qwen2.5-1.5B-Instruct-SFT"  # Update path as needed
